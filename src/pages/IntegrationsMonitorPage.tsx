...
export const IntegrationsMonitorPage: React.FC = () => {
  ...
  const integrations: IntegrationItem[] = [
    {
      id: 'sap_ecc',
      name: 'SAP ECC — ZSD004V_V2 (System of Record)',
      category: 'ERP Central Corporativo',
      type: 'Carga Batch / Arquivo Estruturado',
      status: 'Simulação',
      statusBadgeColor: 'bg-amber-500 text-white',
      currentMode: 'Importação Provisória por Arquivo (CSV/TXT)',
      description:
        'Fonte primária da verdade de cadastros de motoristas e veículos. Processamento local via importador provisório.',
      details:
        'Aviso de Arquitetura: Será substituída na fase de go-live corporativo pela integração direta via RFC/IDoc (sem REST/OData customizado).',
      lastSync: 'Manual via painel SAP Import',
      fase: 'Sprint 1.1 (Provisória)',
    },
    {
      id: 'telegram_bot',
      name: 'Telegram Bot (Chicão / Notificações)',
      category: 'Mensageria & Conversacional',
      type: 'Bot API & Polling/Webhook',
      status: 'Não configurado',
      statusBadgeColor: 'bg-slate-500 text-white',
      currentMode: 'Não Implementado (Interface Simulada)',
      description:
        'Canal para notificação de ofertas de frete e interação conversacional com motoristas.',
      details:
        'Arquitetura desacoplada via adapter CanalMensagem. Nenhuma credencial cadastrada ou chamada de rede ativa nesta sprint.',
      fase: 'Sprint 2',
    },
    {
      id: 'whatsapp_meta',
      name: 'WhatsApp Cloud API / Gupshup',
      category: 'Mensageria Oficial',
      type: 'Business API REST',
      status: 'Não configurado',
      statusBadgeColor: 'bg-slate-500 text-white',
      currentMode: 'Não Implementado (Interface Simulada)',
      description:
        'Canal corporativo WhatsApp para disparo de templates de oferta e links de check-in geográfico.',
      details:
        'Desacoplado via adapter CanalMensagem. Sem credenciais nem custos nesta sprint de homologação.',
      fase: 'Sprint 2',
    },
    {
      id: 'qlik_sense',
