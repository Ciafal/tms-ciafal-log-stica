...
export const TmsService = {
  ...
  async getSapBlueprintMappings(): Promise<any[]> {
    ...
    // Blueprint Oficial Completo com as 12 colunas da Sprint 4.1
    return [
      {
        id: 'BP-01',
        process_name: 'Leitura da Carteira de Pedidos',
        origin_system: 'SAP ECC',
        object_type: 'Transação / RFC Z',
        sap_object: 'ZSD35 / Objeto RFC a confirmar com consultoria SAP',
        sap_field: 'VBELN, POSNR, KUNNR, MATNR, KWMENG, LFIMG, NETWR, ROUTE, EDATU',
        tms_field:
          'order_number, item_number, customer_code, material_code, quantity, weight_kg, value, itinerary_code, desired_date',
        is_mandatory: true,
        transformation:
      ...
      },
      {
        ...
        origin_system: 'SAP ECC',
        object_type: 'View / RFC',
        sap_object: 'ZSD004V_V2 / RFC a confirmar com consultoria SAP',
        sap_field: 'MANDT, CPF, NOME, PLACA, TIPO_VEIC, CAP_KG, STAT_BLOQ',
        tms_field: 'document, name, plate, vehicle_type, capacity_kg, status',
        is_mandatory: true,
        transformation:
      ...
      {
        id: 'BP-03',
        process_name: 'Cadastro Mestre de Clientes & Ship-to',
        origin_system: 'SAP ECC',
        object_type: 'Tabela Standard',
        sap_object: 'KNA1 / VBPA (Parceiro WE - Recebedor)',
        sap_field: 'KUNNR, NAME1, STRAS, ORT01, REGIO, PSTLZ, STCD1',
        tms_field: 'customer_code, customer_name, address, city, uf, postal_code, cnpj',
        is_mandatory: true,
      ...
      {
        id: 'BP-04',
        process_name: 'Itinerários Oficiais de Entrega',
        origin_system: 'SAP ECC',
        object_type: 'Tabela Standard',
        sap_object: 'TVROT (Tabela de Itinerários / Rotas)',
        sap_field: 'ROUTE, BEZEI, DISTZ, MEDST',
        tms_field: 'sap_code, description, default_distance_km, unit',
        is_mandatory: true,
        transformation:
      ...
      },
      {
        ...
        sap_field: 'TDOBJECT=VBBK, TDNAME=VBELN, TDID=0001, LINES',
      ...
      },
      {
        ...
        origin_system: 'SAP ECC',
        object_type: 'BAPI Standard',
        sap_object: 'BAPI_MATERIAL_AVAILABILITY / MARD / MB52',
        sap_field: 'MATNR, WERKS, LGORT, LABST, INSME, SPEME',
        tms_field: 'material_code, plant, storage_loc, available_stock, blocked_stock',
        is_mandatory: true,
      ...
      },
      {
        ...
        sap_field: 'KUNNR, KKBER, KLIMK, SKFOR, SSOBL, CMGST',
        tms_field: 'customer_code, credit_limit, current_exposure, credit_status, is_approved',
        is_mandatory: true,
      ...
      },
      {
        ...
        object_type: 'BAPI / qRFC',
        sap_object: 'BAPI_SHIPMENT_CREATE / VT01N / ZSD_SHIPMENT',
        sap_field: 'HEADER, ITEM, STAGES, PARTNERS, DATES',
        tms_field: 'cargo_id, itinerary_code, vehicle_plate, driver_doc, orders, total_weight_kg',
        is_mandatory: true,
        transformation:
      ...
      {
        id: 'BP-09',
        process_name: 'Retorno de Status de Transporte do SAP',
        origin_system: 'SAP ECC',
        object_type: 'IDoc / RFC',
        sap_object: 'SHPMNT05 / Evento VT02N',
        sap_field: 'TKNUM, STTRG, SIGNI, EXTNUM',
        tms_field: 'sap_transport_number, sap_status, correlation_id',
        is_mandatory: true,
